...
/**
 * This class defines common {@link Block} transformation behaviour
...
public abstract class BlockTransformation {
    ...
    /**
     * @param block - defines transformation {@link Block}
     */
     ...
     * @param p - {@link Point} representing spreadsheet cell to transform
