...
public abstract class BaseRowTransformer implements RowTransformer{
    ...
    /**
     * Adds new {@link ListRange} to the map of ranges and updates formulas if there is range with the same name already
     *
     ...
     *
     * @param cell - {@link Cell} object with cell information
     */
