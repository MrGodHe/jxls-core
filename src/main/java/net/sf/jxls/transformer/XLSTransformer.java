...
//    private Map taglibs = new HashMap();
    ...
    /**
     * Registers {@link RowProcessor} object
     * @param rowProcessor {@link RowProcessor} to register
     */
    ...
    /**
     * Registers {@link CellProcessor} object
     * @param cellProcessor {@link CellProcessor to register}
     */
...
//    }
    ...
    /**
     * @return {@link FormulaResolver} used to resolve coded formulas
     */
     ...
     * @throws ParsePropertyException - {@link ParsePropertyException} is thrown when some property can't be parsed
     */
